...
export const seedOrders: CustomerOrder[] = [
  {
    ...
    items: [
      { name: 'Standard Bag', quantity: 2, price: 49.5 },
      { name: 'Shirt Bag', quantity: 1, price: 25.5 },
    ],
    deliveryFee: 45,
    total: 169.5,
    paymentMethod: 'Card',
  ...
  },
  {
    ...
    driverPhone: '083 456 7890',
    items: [
      { name: 'Duvet Cover (Large)', quantity: 1, price: 60 },
      { name: 'Standard Bag', quantity: 1, price: 49.5 },
    ],
    deliveryFee: 45,
    total: 154.5,
    paymentMethod: 'EFT',
  ...
  },
  {
    ...
    items: [
      { name: 'Standard Bag', quantity: 3, price: 49.5 },
      { name: 'Suit Bag', quantity: 2, price: 32.5 },
    ],
    deliveryFee: 45,
    total: 258.5,
    paymentMethod: 'Card',
